...
@ManagedBean(name = "KampanyaBean")
@SessionScoped
public class KampanyaBean {
 ...
 return sqlDate;
    ...
    public ResultSet getKampanya() throws SQLException {
        ...
        try {
            PreparedStatement object2 = connection.prepareStatement(
                    "SELECT ID, TARIH,ISIM, BASLIK, ACIKLAMA FROM KAMPANYA  ORDER BY TARIH DESC");
    ...
    public String ekle() throws SQLException, ParseException {
        ...
        try {
            ...
            PreparedStatement object1
                    = connection.prepareStatement("INSERT INTO KAMPANYA "
    ...
    public String sil() throws SQLException {
        ...
        try {
            ...
            PreparedStatement myObject
                    = connection.prepareStatement("delete from KAMPANYA where id=?");
    ...
    public String guncelle() throws SQLException, ParseException {
        ...
        try {
            ...
            PreparedStatement myObject
                    = connection.prepareStatement("UPDATE KAMPANYA SET TARIH=?,ISIM=?,BASLIK=?,ACIKLAMA=? WHERE ID=?");
    ...
    public String sec() throws SQLException {
        ...
        try {
            PreparedStatement object2 = connection.prepareStatement(
                    "SELECT ID,TARIH,ISIM, BASLIK, ACIKLAMA FROM KAMPANYA where id=?");
    ...
    public ResultSet getKampanyaAltCek() throws SQLException {
        ...
        try {
            PreparedStatement object2 = connection.prepareStatement(
                    "SELECT * FROM KAMPANYA FETCH FIRST 2 ROWS ONLY");
